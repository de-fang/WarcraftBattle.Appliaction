...
namespace WarcraftBattle.Shared.Models.Config
{
    ...
    public class UnitConfig
    {
        ...
        public string TypeString
        {
            ...
            set =>
                Type =
                    (value != null && Enum.TryParse(value, out UnitType r)) ? r : (UnitType?)null;
        }
        ...
        public string AtkTypeString
        {
            ...
            set =>
                AtkType =
                    (value != null && Enum.TryParse(value, out AttackType r))
                        ? r
                        : (AttackType?)null;
        }
        ...
        public string DefTypeString
        {
            ...
            set =>
                DefType =
                    (value != null && Enum.TryParse(value, out ArmorType r)) ? r : (ArmorType?)null;
        }
        ...
        {
            get => IsMounted?.ToString().ToLower();
    ...
    public class StageConfig
    {
        ...
        [XmlArray("Placements")]
        [XmlArrayItem("Entity")]
        public List<EntityPlacementConfig> Placements { get; set; } =
            new List<EntityPlacementConfig>();
